...
public class FlatModeSqlGeneratorTest extends SqlGeneratorTest
{
    ...
    public static void setUpResults() throws Exception {
        ...
        results.put("ContainsConstraintNull", "SELECT a1_.addressId AS a1_addressId, a1_.age AS a1_age, a1_.companyId AS a1_companyId, a1_.departmentId AS a1_departmentId, a1_.departmentThatRejectedMeId AS a1_departmentThatRejectedMeId, a1_.employmentPeriodId AS a1_employmentPeriodId, a1_.fullTime AS a1_fullTime, a1_.id AS a1_id, a1_.intermine_end AS a1_intermine_end, a1_.name AS a1_name, a1_.salary AS a1_salary, a1_.seniority AS a1_seniority, a1_.title AS a1_title, a1_.class AS a1_objectclass FROM Employee AS a1_ WHERE a1_.tableclass = 'Employee' AND a1_.addressId IS NULL ORDER BY a1_.id");
        results2.put("ContainsConstraintNull", Collections.singleton("Employee"));
        results.put("ContainsConstraintNotNull", "SELECT a1_.addressId AS a1_addressId, a1_.age AS a1_age, a1_.companyId AS a1_companyId, a1_.departmentId AS a1_departmentId, a1_.departmentThatRejectedMeId AS a1_departmentThatRejectedMeId, a1_.employmentPeriodId AS a1_employmentPeriodId, a1_.fullTime AS a1_fullTime, a1_.id AS a1_id, a1_.intermine_end AS a1_intermine_end, a1_.name AS a1_name, a1_.salary AS a1_salary, a1_.seniority AS a1_seniority, a1_.title AS a1_title, a1_.class AS a1_objectclass FROM Employee AS a1_ WHERE a1_.tableclass = 'Employee' AND a1_.addressId IS NOT NULL ORDER BY a1_.id");
        ...
        results.put("ContainsConstraintObjectRefObject", "SELECT a1_.addressId AS a1_addressId, a1_.age AS a1_age, a1_.companyId AS a1_companyId, a1_.departmentId AS a1_departmentId, a1_.departmentThatRejectedMeId AS a1_departmentThatRejectedMeId, a1_.employmentPeriodId AS a1_employmentPeriodId, a1_.fullTime AS a1_fullTime, a1_.id AS a1_id, a1_.intermine_end AS a1_intermine_end, a1_.name AS a1_name, a1_.salary AS a1_salary, a1_.seniority AS a1_seniority, a1_.title AS a1_title, a1_.class AS a1_objectclass FROM Employee AS a1_ WHERE a1_.tableclass = 'Employee' AND a1_.departmentId = 5 ORDER BY a1_.id");
        ...
        results.put("ContainsConstraintCollectionRefObject", "SELECT a1_.companyId AS a1_companyId, a1_.id AS a1_id, a1_.managerId AS a1_managerId, a1_.name AS a1_name FROM Department AS a1_, Employee AS indirect0 WHERE indirect0.tableclass = 'Employee' AND a1_.id = indirect0.departmentId AND indirect0.id = 11 ORDER BY a1_.id");
        ...
        results.put("SimpleConstraintNull", "SELECT a1_.addressId AS a1_addressId, a1_.age AS a1_age, a1_.companyId AS a1_companyId, a1_.departmentId AS a1_departmentId, a1_.departmentThatRejectedMeId AS a1_departmentThatRejectedMeId, a1_.employmentPeriodId AS a1_employmentPeriodId, a1_.fullTime AS a1_fullTime, a1_.id AS a1_id, a1_.intermine_end AS a1_intermine_end, a1_.name AS a1_name, a1_.salary AS a1_salary, a1_.seniority AS a1_seniority, a1_.title AS a1_title, a1_.class AS a1_objectclass FROM Employee AS a1_ WHERE a1_.tableclass = 'Manager' AND a1_.title IS NULL ORDER BY a1_.id");
        results2.put("SimpleConstraintNull", Collections.singleton("Employee"));
        results.put("SimpleConstraintNotNull", "SELECT a1_.addressId AS a1_addressId, a1_.age AS a1_age, a1_.companyId AS a1_companyId, a1_.departmentId AS a1_departmentId, a1_.departmentThatRejectedMeId AS a1_departmentThatRejectedMeId, a1_.employmentPeriodId AS a1_employmentPeriodId, a1_.fullTime AS a1_fullTime, a1_.id AS a1_id, a1_.intermine_end AS a1_intermine_end, a1_.name AS a1_name, a1_.salary AS a1_salary, a1_.seniority AS a1_seniority, a1_.title AS a1_title, a1_.class AS a1_objectclass FROM Employee AS a1_ WHERE a1_.tableclass = 'Manager' AND a1_.title IS NOT NULL ORDER BY a1_.id");
        results2.put("SimpleConstraintNotNull", Collections.singleton("Employee"));
        results.put("TypeCast", "SELECT DISTINCT (a1_.age)::TEXT AS a2_ FROM Employee AS a1_ WHERE a1_.tableclass = 'Employee' ORDER BY (a1_.age)::TEXT");
        results.put("IndexOf", "SELECT STRPOS(a1_.name, 'oy') AS a2_ FROM Employee AS a1_ WHERE a1_.tableclass = 'Employee' ORDER BY STRPOS(a1_.name, 'oy')");
        results.put("Substring", "SELECT SUBSTR(a1_.name, 2, 2) AS a2_ FROM Employee AS a1_ WHERE a1_.tableclass = 'Employee' ORDER BY SUBSTR(a1_.name, 2, 2)");
        results.put("Substring2", "SELECT SUBSTR(a1_.name, 2) AS a2_ FROM Employee AS a1_ WHERE a1_.tableclass = 'Employee' ORDER BY SUBSTR(a1_.name, 2)");
        results.put("OrderByReference", "SELECT a1_.addressId AS a1_addressId, a1_.age AS a1_age, a1_.companyId AS a1_companyId, a1_.departmentId AS a1_departmentId, a1_.departmentThatRejectedMeId AS a1_departmentThatRejectedMeId, a1_.employmentPeriodId AS a1_employmentPeriodId, a1_.fullTime AS a1_fullTime, a1_.id AS a1_id, a1_.intermine_end AS a1_intermine_end, a1_.name AS a1_name, a1_.salary AS a1_salary, a1_.seniority AS a1_seniority, a1_.title AS a1_title, a1_.class AS a1_objectclass FROM Employee AS a1_ WHERE a1_.tableclass = 'Employee' ORDER BY a1_.departmentId, a1_.id");
        ...
        results.put("LargeBagConstraintUsingTable", "SELECT a1_.addressId AS a1_addressId, a1_.age AS a1_age, a1_.companyId AS a1_companyId, a1_.departmentId AS a1_departmentId, a1_.departmentThatRejectedMeId AS a1_departmentThatRejectedMeId, a1_.employmentPeriodId AS a1_employmentPeriodId, a1_.fullTime AS a1_fullTime, a1_.id AS a1_id, a1_.intermine_end AS a1_intermine_end, a1_.name AS a1_name, a1_.salary AS a1_salary, a1_.seniority AS a1_seniority, a1_.title AS a1_title, a1_.class AS a1_objectclass FROM Employee AS a1_, " + LARGE_BAG_TABLE_NAME + " AS indirect0 WHERE a1_.tableclass = 'Employee' AND a1_.name = indirect0.value ORDER BY a1_.id");
        results2.put("LargeBagConstraintUsingTable", Collections.singleton("Employee"));

        results.put("LargeBagNotConstraintUsingTable", "SELECT a1_.addressId AS a1_addressId, a1_.age AS a1_age, a1_.companyId AS a1_companyId, a1_.departmentId AS a1_departmentId, a1_.departmentThatRejectedMeId AS a1_departmentThatRejectedMeId, a1_.employmentPeriodId AS a1_employmentPeriodId, a1_.fullTime AS a1_fullTime, a1_.id AS a1_id, a1_.intermine_end AS a1_intermine_end, a1_.name AS a1_name, a1_.salary AS a1_salary, a1_.seniority AS a1_seniority, a1_.title AS a1_title, a1_.class AS a1_objectclass FROM Employee AS a1_ WHERE a1_.tableclass = 'Employee' AND (NOT (a1_.name IN (SELECT value FROM " + LARGE_BAG_TABLE_NAME + "))) ORDER BY a1_.id");
        results2.put("LargeBagNotConstraintUsingTable", Collections.singleton("Employee"));

        results.put("NegativeNumbers", "SELECT a1_.addressId AS a1_addressId, a1_.age AS a1_age, a1_.companyId AS a1_companyId, a1_.departmentId AS a1_departmentId, a1_.departmentThatRejectedMeId AS a1_departmentThatRejectedMeId, a1_.employmentPeriodId AS a1_employmentPeriodId, a1_.fullTime AS a1_fullTime, a1_.id AS a1_id, a1_.intermine_end AS a1_intermine_end, a1_.name AS a1_name, a1_.salary AS a1_salary, a1_.seniority AS a1_seniority, a1_.title AS a1_title, a1_.class AS a1_objectclass FROM Employee AS a1_ WHERE a1_.tableclass = 'Employee' AND a1_.age > -51 ORDER BY a1_.id");
        results2.put("NegativeNumbers", Collections.singleton("Employee"));

        results.put("Lower", "SELECT LOWER(a1_.name) AS a2_ FROM Employee AS a1_ WHERE a1_.tableclass = 'Employee' ORDER BY LOWER(a1_.name)");

        results.put("Upper", "SELECT UPPER(a1_.name) AS a2_ FROM Employee AS a1_ WHERE a1_.tableclass = 'Employee' ORDER BY UPPER(a1_.name)");
        results.put("CollectionQueryOneMany", "SELECT a1_.addressId AS a1_addressId, a1_.age AS a1_age, a1_.companyId AS a1_companyId, a1_.departmentId AS a1_departmentId, a1_.departmentThatRejectedMeId AS a1_departmentThatRejectedMeId, a1_.employmentPeriodId AS a1_employmentPeriodId, a1_.fullTime AS a1_fullTime, a1_.id AS a1_id, a1_.intermine_end AS a1_intermine_end, a1_.name AS a1_name, a1_.salary AS a1_salary, a1_.seniority AS a1_seniority, a1_.title AS a1_title, a1_.class AS a1_objectclass FROM Employee AS a1_ WHERE a1_.tableclass = 'Employee' AND " + departmentA1Id + " = a1_.departmentId ORDER BY a1_.id");
        ...
        results.put("QueryClassBag", "SELECT a2_.departmentId AS a3_, a2_.addressId AS a2_addressId, a2_.age AS a2_age, a2_.companyId AS a2_companyId, a2_.departmentId AS a2_departmentId, a2_.departmentThatRejectedMeId AS a2_departmentThatRejectedMeId, a2_.employmentPeriodId AS a2_employmentPeriodId, a2_.fullTime AS a2_fullTime, a2_.id AS a2_id, a2_.intermine_end AS a2_intermine_end, a2_.name AS a2_name, a2_.salary AS a2_salary, a2_.seniority AS a2_seniority, a2_.title AS a2_title, a2_.class AS a2_objectclass FROM Employee AS a2_ WHERE a2_.tableclass = 'Employee' AND a2_.departmentId IN (" + departmentA1Id + ", " + departmentB1Id + ") ORDER BY a2_.departmentId, a2_.id");
        ...
        results.put("QueryClassBagDouble", "SELECT a2_.departmentId AS a4_, a2_.addressId AS a2_addressId, a2_.age AS a2_age, a2_.companyId AS a2_companyId, a2_.departmentId AS a2_departmentId, a2_.departmentThatRejectedMeId AS a2_departmentThatRejectedMeId, a2_.employmentPeriodId AS a2_employmentPeriodId, a2_.fullTime AS a2_fullTime, a2_.id AS a2_id, a2_.intermine_end AS a2_intermine_end, a2_.name AS a2_name, a2_.salary AS a2_salary, a2_.seniority AS a2_seniority, a2_.title AS a2_title, a2_.class AS a2_objectclass, a3_.addressId AS a3_addressId, a3_.age AS a3_age, a3_.companyId AS a3_companyId, a3_.departmentId AS a3_departmentId, a3_.departmentThatRejectedMeId AS a3_departmentThatRejectedMeId, a3_.employmentPeriodId AS a3_employmentPeriodId, a3_.fullTime AS a3_fullTime, a3_.id AS a3_id, a3_.intermine_end AS a3_intermine_end, a3_.name AS a3_name, a3_.salary AS a3_salary, a3_.seniority AS a3_seniority, a3_.title AS a3_title, a3_.class AS a3_objectclass FROM Employee AS a2_, Employee AS a3_ WHERE a2_.tableclass = 'Employee' AND a3_.tableclass = 'Employee' AND a2_.departmentId IN (" + departmentA1Id + ", " + departmentB1Id + ") AND a3_.departmentId = a2_.departmentId ORDER BY a2_.departmentId, a2_.id, a3_.id");
        results2.put("QueryClassBagDouble", Collections.singleton("Employee"));
        results.put("QueryClassBagContainsObject", "SELECT indirect0.departmentId AS a2_ FROM Employee AS indirect0 WHERE indirect0.tableclass = 'Employee' AND indirect0.departmentId IN (" + departmentA1Id + ", " + departmentB1Id + ") AND indirect0.id = " + employeeA1Id + " ORDER BY indirect0.departmentId");
        results.put("QueryClassBagContainsObjectDouble", "SELECT indirect0.departmentId AS a2_ FROM Employee AS indirect0, Employee AS indirect1 WHERE indirect0.tableclass = 'Employee' AND indirect0.departmentId IN (" + departmentA1Id + ", " + departmentB1Id + ") AND indirect0.id = " + employeeA1Id + " AND indirect1.tableclass = 'Employee' AND indirect1.departmentId = indirect0.departmentId AND indirect1.id = " + employeeA2Id + " ORDER BY indirect0.departmentId");
        results.put("ObjectContainsObject", "SELECT 'hello' AS a1_ FROM Employee AS indirect0 WHERE indirect0.tableclass = 'Employee' AND " + departmentA1Id + " = indirect0.departmentId AND indirect0.id = " + employeeA1Id);
        results.put("ObjectContainsObject2", "SELECT 'hello' AS a1_ FROM Employee AS indirect0 WHERE indirect0.tableclass = 'Employee' AND " + departmentA1Id + " = indirect0.departmentId AND indirect0.id = " + employeeB1Id);
        results.put("ObjectNotContainsObject", "SELECT 'hello' AS a1_ FROM Employee AS indirect0 WHERE indirect0.tableclass = 'Employee' AND " + departmentA1Id + " != indirect0.departmentId AND indirect0.id = " + employeeA1Id);
        results.put("ObjectPathExpression", "SELECT a1_.addressId AS a1_addressId, a1_.age AS a1_age, a1_.companyId AS a1_companyId, a1_.departmentId AS a1_departmentId, a1_.departmentThatRejectedMeId AS a1_departmentThatRejectedMeId, a1_.employmentPeriodId AS a1_employmentPeriodId, a1_.fullTime AS a1_fullTime, a1_.id AS a1_id, a1_.intermine_end AS a1_intermine_end, a1_.name AS a1_name, a1_.salary AS a1_salary, a1_.seniority AS a1_seniority, a1_.title AS a1_title, a1_.class AS a1_objectclass FROM Employee AS a1_ WHERE a1_.tableclass = 'Employee' ORDER BY a1_.id");
        ...
        results.put("LowerBag", "SELECT a1_.addressId AS a1_addressId, a1_.age AS a1_age, a1_.companyId AS a1_companyId, a1_.departmentId AS a1_departmentId, a1_.departmentThatRejectedMeId AS a1_departmentThatRejectedMeId, a1_.employmentPeriodId AS a1_employmentPeriodId, a1_.fullTime AS a1_fullTime, a1_.id AS a1_id, a1_.intermine_end AS a1_intermine_end, a1_.name AS a1_name, a1_.salary AS a1_salary, a1_.seniority AS a1_seniority, a1_.title AS a1_title, a1_.class AS a1_objectclass FROM Employee AS a1_ WHERE a1_.tableclass = 'Employee' AND LOWER(a1_.name) IN ('employeea1', 'employeea2', 'employeeb1') ORDER BY a1_.id");
        results2.put("LowerBag", Collections.singleton("Employee"));
        results.put("ObjectStoreBag", "SELECT a1_.addressId AS a1_addressId, a1_.age AS a1_age, a1_.companyId AS a1_companyId, a1_.departmentId AS a1_departmentId, a1_.departmentThatRejectedMeId AS a1_departmentThatRejectedMeId, a1_.employmentPeriodId AS a1_employmentPeriodId, a1_.fullTime AS a1_fullTime, a1_.id AS a1_id, a1_.intermine_end AS a1_intermine_end, a1_.name AS a1_name, a1_.salary AS a1_salary, a1_.seniority AS a1_seniority, a1_.title AS a1_title, a1_.class AS a1_objectclass FROM Employee AS a1_, " + ObjectStoreInterMineImpl.INT_BAG_TABLE_NAME + " AS indirect0 WHERE a1_.tableclass = 'Employee' AND a1_.id = indirect0." + ObjectStoreInterMineImpl.BAGVAL_COLUMN + " AND indirect0." + ObjectStoreInterMineImpl.BAGID_COLUMN + " = 5 ORDER BY a1_.id");
        results2.put("ObjectStoreBag", new HashSet(Arrays.asList(new String[] {"Employee", ObjectStoreInterMineImpl.INT_BAG_TABLE_NAME})));
        results.put("OrderDescending", "SELECT a1_.addressId AS a1_addressId, a1_.age AS a1_age, a1_.companyId AS a1_companyId, a1_.departmentId AS a1_departmentId, a1_.departmentThatRejectedMeId AS a1_departmentThatRejectedMeId, a1_.employmentPeriodId AS a1_employmentPeriodId, a1_.fullTime AS a1_fullTime, a1_.id AS a1_id, a1_.intermine_end AS a1_intermine_end, a1_.name AS a1_name, a1_.salary AS a1_salary, a1_.seniority AS a1_seniority, a1_.title AS a1_title, a1_.class AS a1_objectclass FROM Employee AS a1_ WHERE a1_.tableclass = 'Employee' ORDER BY a1_.id DESC");
        results2.put("OrderDescending", Collections.singleton("Employee"));
        results.put("SelectForeignKey", "SELECT a1_.departmentId AS a2_ FROM Employee AS a1_ WHERE a1_.tableclass = 'Employee' ORDER BY a1_.departmentId");
        results.put("WhereCount", "SELECT a1_.companyId AS a1_companyId, a1_.id AS a1_id, a1_.managerId AS a1_managerId, a1_.name AS a1_name, COUNT(*) AS a3_ FROM Department AS a1_, Employee AS a2_ WHERE a2_.tableclass = 'Employee' AND a1_.id = a2_.departmentId GROUP BY a1_.companyId, a1_.id, a1_.managerId, a1_.name HAVING COUNT(*) > 1 ORDER BY a1_.id, a3_");
        results2.put("WhereCount", new HashSet(Arrays.asList("Employee", "Department")));
        results.put("LimitedSubquery", "SELECT DISTINCT a1_.a2_ AS a2_ FROM (SELECT a1_.name AS a2_ FROM Employee AS a1_ WHERE a1_.tableclass = 'Employee' LIMIT 3) AS a1_ ORDER BY a1_.a2_");
        ...
        results.put("MergeFalse", "SELECT a1_.addressId AS a1_addressId, a1_.age AS a1_age, a1_.companyId AS a1_companyId, a1_.departmentId AS a1_departmentId, a1_.departmentThatRejectedMeId AS a1_departmentThatRejectedMeId, a1_.employmentPeriodId AS a1_employmentPeriodId, a1_.fullTime AS a1_fullTime, a1_.id AS a1_id, a1_.intermine_end AS a1_intermine_end, a1_.name AS a1_name, a1_.salary AS a1_salary, a1_.seniority AS a1_seniority, a1_.title AS a1_title, a1_.class AS a1_objectclass FROM Employee AS a1_ WHERE a1_.tableclass = 'Employee' AND (a1_.age > 3) ORDER BY a1_.id");
        ...
        results.put("SelectFunctionNoGroup", "SELECT MIN(a1_.id) AS a2_ FROM Employee AS a1_ WHERE a1_.tableclass = 'Employee'");
        results2.put("SelectFunctionNoGroup", Collections.singleton("Employee"));
        results.put("SelectClassFromEmployee", "SELECT a1_.class AS a2_, COUNT(*) AS a3_ FROM Employee AS a1_ WHERE a1_.tableclass = 'Employee' GROUP BY a1_.class ORDER BY a1_.class, a3_");
        ...
        results.put("SelectWhereBackslash", "SELECT a1_.addressId AS a1_addressId, a1_.age AS a1_age, a1_.companyId AS a1_companyId, a1_.departmentId AS a1_departmentId, a1_.departmentThatRejectedMeId AS a1_departmentThatRejectedMeId, a1_.employmentPeriodId AS a1_employmentPeriodId, a1_.fullTime AS a1_fullTime, a1_.id AS a1_id, a1_.intermine_end AS a1_intermine_end, a1_.name AS a1_name, a1_.salary AS a1_salary, a1_.seniority AS a1_seniority, a1_.title AS a1_title, a1_.class AS a1_objectclass FROM Employee AS a1_ WHERE a1_.tableclass = 'Employee' AND a1_.name = E'Fred\\\\Blog\\'s' ORDER BY a1_.id");
        ...
        results.put("MultipleInBagConstraint1", "SELECT a1_.addressId AS a1_addressId, a1_.age AS a1_age, a1_.companyId AS a1_companyId, a1_.departmentId AS a1_departmentId, a1_.departmentThatRejectedMeId AS a1_departmentThatRejectedMeId, a1_.employmentPeriodId AS a1_employmentPeriodId, a1_.fullTime AS a1_fullTime, a1_.id AS a1_id, a1_.intermine_end AS a1_intermine_end, a1_.name AS a1_name, a1_.salary AS a1_salary, a1_.seniority AS a1_seniority, a1_.title AS a1_title, a1_.class AS a1_objectclass FROM Employee AS a1_ WHERE a1_.tableclass = 'Employee' AND (a1_.intermine_end IN ('1', '2', 'EmployeeA1', 'EmployeeB1') OR a1_.name IN ('1', '2', 'EmployeeA1', 'EmployeeB1')) ORDER BY a1_.id");
    ...
    public String getRegisterOffset3() {
        return "Employee AS a1_ WHERE a1_.tableclass = 'Employee'";
    }
